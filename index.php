                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Usuario" name="usuario" value="ana"></div>
                    <div class="form-group">
                      <label for="">Contraseña</label>
                      <input type="password" class="form-control" placeholder="Contraseña" name="clave" value="123456789">
                    </div>
